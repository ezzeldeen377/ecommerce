...
class CartDetailsDataSourceImpl implements CartDetailsDataSource {
    ...
    try {
      ...
      if (checkConnection.contains(ConnectivityResult.mobile) ||
        ...
        var response = await apiManager
            .getData(EndPoint.addToCart, headers: {'token': token});

        var cartDetailsResponse =
            CartDetailsResponseDto.fromJson(response.data);
  ...
  Future<Either<Failures, CartDetailsResponseDto>> deleteItemFromCart(
  ...
  @override
  Future<Either<Failures, CartDetailsResponseEntity>> updateItemQuantity(
      String productId, double count) async {
