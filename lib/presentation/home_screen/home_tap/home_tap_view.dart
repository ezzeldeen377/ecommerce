...
import 'package:ecommerce/presentation/home_screen/widgets/category_item.dart';
...
class HomeTapView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeTapViewModel, HomeTapStates>(
        bloc: HomeTapViewModel.getInit(context)
          ..getCategory()
          ..getBrand(),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ImageSlideshow(
                        ...
                        children: HomeTapViewModel.getInit(context)
                            .adsList
                            .map((path) {
                        ...
                        child: state is CategorySuccessState ||
                            ...
                            ? GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return CategoryItem(
                                    categoryData:
                                        HomeTapViewModel.getInit(context)
                                            .categoryList[index],
                                  );
                                },
                                itemCount: HomeTapViewModel.getInit(context)
                                    .categoryList
                                    .length,
