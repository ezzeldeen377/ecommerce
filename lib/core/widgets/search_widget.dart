...
import 'package:ecommerce/presentation/home_screen/cart_details/cart_view.dart';
    ...
    return Row(
      children: [
        ...
        Padding(
          ...
          child: Badge(
            backgroundColor: ShopTabViewModel.get(context).numOfCartItems == 0
                ? Colors.transparent
                : AppColors.redColor,
            label: ShopTabViewModel.get(context).numOfCartItems == 0
                ? null
