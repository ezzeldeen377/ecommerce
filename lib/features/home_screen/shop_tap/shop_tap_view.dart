...
import 'package:ecommerce/features/home_screen/widgets/product_item.dart';
              ...
              Padding(
                ...
                child: GridView.builder(
                    ...
                    , itemBuilder: (context,index){
                      return InkWell (
                        onTap: (){
                          ShopTabViewModel.get(context).selectedColor=null;
                          ShopTabViewModel.get(context).selectedSize=null;
                         Navigator.push(context,MaterialPageRoute(
                             builder: (context)=>ProductDetailsView(
                                 product:ShopTabViewModel.get(context).productList[index])));
                        },
                          child: ProductItem(product: ShopTabViewModel.get(context).productList[index],));
                },
                            itemCount:ShopTabViewModel.get(context).productList.length,
                ),
              ):
