...
import 'package:ecommerce/presentation/home_screen/widgets/cart_item.dart';
        ...
        builder: (context, state) {
          return Scaffold(
            ...
            appBar: AppBar(
              backgroundColor: AppColors.whiteColor,
              title: Text(
                ConstantManager.cart,
                style: getMediumStyle(
                    color: AppColors.blackColor, size: FontSize.s20.sp),
              ),
              centerTitle: true,
              actions: [
                Padding(
            ...
            body: CartDetailsViewModel.get(context).productList != null
                ? ListView.builder(
                    itemCount:
                        CartDetailsViewModel.get(context).productList!.length,
                    itemBuilder: (context, index) {
                      return CartItem(
                        product: CartDetailsViewModel.get(context)
                            .productList![index],
                      );
                    })
                : Center(
            ...
            bottomNavigationBar: CartDetailsViewModel.get(context).cart != null
                ? BottomAppBar(
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            Text(
                              'EGP ${CartDetailsViewModel.get(context).cart!.data!.totalCartPrice}',
                              style: getMediumStyle(
