            ...
            children: [
              CachedNetworkImage(
                ...
                errorWidget: (context, url, error) => Container(
                    height: 100.h, child: Center(child: Icon(Icons.error))),
              ),
              Padding(
                  ...
                  children: [
                    Text(
                      ...
                      style: getSemiBoldStyle(
                          color: AppColors.blackColor, size: FontSize.s14),
                    ...
                    Text(
                      product.description ?? '',
                      style: getSemiBoldStyle(
                          color: AppColors.blackColor, size: FontSize.s12),
                      overflow: TextOverflow.ellipsis,
                      maxLines: 2,
                    ),
                    Row(
                      children: [
                        ...
                        Text(
                          ' ${getActualPrice(product.price!.toInt()).toString()}EGP',
                          style: getSemiBoldStyle(
                              color: AppColors.primaryColor,
                              size: FontSize.s12,
