...
import 'package:ecommerce/presentation/home_screen/widgets/bottom_navigation_bar_item_widget.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeScreenViewModel, HomeScreenStates>(
        ...
        builder: (context, state) {
          return Scaffold(
            extendBody: true,
            body: HomeScreenViewModel.getInit(context)
                .tabs[HomeScreenViewModel.getInit(context).selectedIndex],
            bottomNavigationBar: Theme(
              ...
              child: Container(
                ...
                child: BottomNavigationBar(
                    currentIndex:
                        HomeScreenViewModel.getInit(context).selectedIndex,
                    onTap: (index) {
                    ...
                    items: [
                      BottomNavigationBarItemWidget
                          .getBottomNavigationBarItemWidget(
